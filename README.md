...
```
muxox
├── Aeromancer (atmospheric-intuition module)
├── Emberwright (exotic-alloy forge protocol)
├── Quantum Diver (reality-interface protocol)
├── Relic Hacker (artifact-reclamation protocol)
└── Whispering Cartographer (cognitive-mapping framework)
```
